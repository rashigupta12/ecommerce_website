...
export default function Navbar() {
  ...
  const { user, isAuthUser, setIsAuthUser, setUser,currentUpdateProduct,setCurrentUpdateProduct } =
  ...
  useEffect(()=>{
    if(
      pathName !== "/admin-view/add-products" && currentUpdateProduct !== null
    )
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2 gap-2">
            ...
            <button
              ...
              type="button"
              className="iinline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
